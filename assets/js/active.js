...
(function($) {
    ...
    jQuery(document).ready(function($) {
        ...
        $(document).ready(function () {
            ...
            // Mobil menüye logo ve dil seçimi ekle

            if ($('.res-mobile-menu-extras').length) {

              $('.res-mobile-menu').prepend($('.res-mobile-menu-extras').html());

            }

          

            // ✅ Mobil menüdeki dil dropdown değişince formu gönder

            $(document).on('change', '.res-mobile-menu .lang-select', function () {
            ...
            // Off-Canvas Mobil Menü Aç/Kapat İşlemleri
